...
export default function MethodPage({ setIsAnalysisModalOpen, setPreSelectedMethod }) {
  ...
  const methodData = {
    ...
    CAF: {
      title: "Constant Amortization Factor (CAF)",
      target: "Cocok untuk: Income & Dividen (Moderat)",
      icon: (
      ...
      concept: "Memberikan kestabilan dan prediktabilitas cash flow layaknya amortisasi hutang.",
      howItWorks: "Membentuk portofolio saham-saham pembagi dividen konsisten atau obligasi dengan membalik pelunasan/pertumbuhan konstan. Metode ini memberikan proteksi nilai aset jangka panjang yang cocok untuk investor tipe income seeker yang tidak terlalu mempedulikan fluktuasi harian.",
      pros: [
        "Prediktabilitas arus kas (cash flow) yang sangat baik.",
        "Cocok untuk passive income jangka panjang dengan tingkat stres yang rendah."
      ],
      cons: [
        "Pertumbuhan kapital (capital appreciation) relatif lambat.",
        "Kaku dalam penyesuaian bobot saat terjadi momentum jangka pendek."
      ]
    }
  };
